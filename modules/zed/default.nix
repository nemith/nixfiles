  ...
  flake.modules.homeManager.zed = {
    ...
    package = let
      ...
      src = pkgs.applyPatches {
        ...
        patches = [
          # https://github.com/zed-industries/zed/pull/58300 — vendored.
          # Unmerged; realigned to zed 1.7's set_base_text, which lost its
          # 4th arg and now returns Task<()> instead of an awaitable Result.
          ./claude-code-ide.patch
        ];
      };
    in
      pkgs.zed-editor.overrideAttrs (prev: {
        ...
        cargoDeps = pkgs.rustPlatform.fetchCargoVendor {
          pname = "zed-editor";
          inherit version src;
          hash = "sha256-+L/ocblWmZtlOeIvACKlqeUCi982ojXj8HNwlvbqQ/U=";
        };
